...
class Output:
    ...
    def plot_n_elements(self, other1, other2, other3):
        ...
        fig.suptitle("Total Number of Elements Withdrawn from Stack")
        fname = image_name.split('.')
    ...
    def plot_max_elements(self, other1, other2, other3):
        ...
        fig.suptitle("Maximum Number of Elements in Stack")
        fname = image_name.split('.')
...
def bfs_and_a_star_with_stack(index):
    ...
    if found:
        ...
        # print("Number of elements withdrawn from the stack: ", j)
        # print("Maximum number of elements in the stack: ", max_element)
...
if __name__ == "__main__":
    ...
    image_name = input("Enter the name of the image the algorithm will work on (Sample input: image.png): ")
    print(image_name)
    print("-------------------Algorithms------------------")
    ...
    print("4- A* with Heap")
    print("5- Analysis (study and comparison of algorithms )")
    alg = input("Select the algorithm and data structure  (Example input: 1): ")
    ...
    print("NOT: coordinates of start and end must be less than width and height .")

    sx, sy = input("Enter the x and y pixel coordinates of the starting point respectively. (Sample input: 350 100): ").split()
    ex, ey = input("Enter the x and y pixel coordinates of the end point respectively. (Sample input: 200 700): ").split()
    ...
    if int(alg) == 1:
        ...
        print("The images printed are BFS stack, BFS heap, A * stack and A * heap respectively.")
        fname = image_name.split('.')
        ...
        print("Algorithm number entered incorrectly please try again. ")
        exit(0)

    print("Number of elements withdrawn from the stack : ", n_elements)
    print("Maximum number of elements in stack : ", max_elements)
